...
import (
	...
	"github.com/pingcap/apiserver/pkg/client/clientset_generated/clientset/scheme"
...
// CoreV1alpha1Client is used to interact with features provided by the core.pingcap.com group.
type CoreV1alpha1Client struct {
	restClient rest.Interface
}

func (c *CoreV1alpha1Client) TidbBackups(namespace string) TidbBackupInterface {
	return newTidbBackups(c, namespace)
}

func (c *CoreV1alpha1Client) TidbInstances(namespace string) TidbInstanceInterface {
	return newTidbInstances(c, namespace)
}
