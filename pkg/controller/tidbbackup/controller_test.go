...
var _ = Describe("TidbBackup controller", func() {
	var instance TidbBackup
	var expectedKey string
	var client TidbBackupInterface
	...
	BeforeEach(func() {
		...
		expectedKey = "tidbbackup-controller-test-handler/instance-1"
	})
	...
	Describe("when creating a new object", func() {
		It("invoke the reconcile method", func() {
			client = cs.CoreV1alpha1().TidbBackups("tidbbackup-controller-test-handler")
