...
package tidbinstance_test

import (
	"time"

	. "github.com/pingcap/apiserver/pkg/apis/core/v1alpha1"
	. "github.com/pingcap/apiserver/pkg/client/clientset_generated/clientset/typed/core/v1alpha1"
...
var _ = Describe("TidbInstance controller", func() {
	var instance TidbInstance
	var expectedKey string
	var client TidbInstanceInterface
	...
	BeforeEach(func() {
		...
		expectedKey = "tidbinstance-controller-test-handler/instance-1"
	})
	...
	Describe("when creating a new object", func() {
		It("invoke the reconcile method", func() {
			client = cs.CoreV1alpha1().TidbInstances("tidbinstance-controller-test-handler")
